...
| 3 | Experimental Diesel Engine Dataset (OBD2) | Real-world dataset collected using an OBD2 data logger from a Ford Fiesta TDCi diesel engine, capturing parameters such as speed, engine RPM, and fuel consumption under varying driving conditions. | [Link](https://github.com/dharathi/Hyd-Diesel-Engine-Project/tree/main/Datasets/OBD2-datalogger/Fiesta-TD-Ci) |
